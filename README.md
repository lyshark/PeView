...
011      0x00017560      0x00005D60      00000064                0x00000040             Load configuration
012      0x00000000      0xFFFFFFFF      00000000                0x00000000             Bound Import
013      0x0001A000      0x00006C00      00000480                0x000001E0             Import Address Table
...
**查询导入表:** 导入表的查询有多个命令，其中`ImportAll`用于查询所有导入过的模块以及该模块的导入函数。
```
[Pe View] # ImportAll
--------------------------------------------------------------------------------------------------------------
